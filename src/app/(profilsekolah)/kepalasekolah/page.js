        ...
        <div className="flex w-full flex-col gap-6 md:flex-row">
          ...
          <div className="w-full basis-2/3 space-y-4">
            <p>
              ...
              perferendis ipsa sequi natus laboriosam perspiciatis sed iste,
              totam nam! Cum?
            </p>
            <p>
            ...
            <p>
              ...
              repellat id ducimus, culpa laboriosam natus maiores nam quaerat
              unde expedita! Placeat mollitia nesciunt necessitatibus dolorum?
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat
              nam nemo neque, id animi et ea fuga possimus quibusdam
              praesentium, velit eveniet voluptatem excepturi natus. Vel
              voluptatem voluptas deserunt quos!
            </p>
          </div>
        </div>
      </div>
