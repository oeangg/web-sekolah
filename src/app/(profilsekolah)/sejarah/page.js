      ...
      <div className="space-y-6 text-base font-normal text-foreground">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            architecto illum adipisci optio ipsum nemo vel eum molestiae ipsa
            eos, quod, quisquam voluptates quos omnis cupiditate aut. Quidem
            doloribus maxime, hic eveniet excepturi exercitationem pariatur sed,
            neque voluptatum tempore necessitatibus.
          </p>
        </div>
      </div>
